...
waveCa = np.linspace(853.9444, 854.9444, 1001)
waveHa = np.linspace(655.9691622298104, 656.9691622298104, 1001)
    ...
    with open(os.devnull, 'w') as f:
        with redirect_stdout(f):
            ...
            if converged:
                ...
                return {'IwaveCa': IwaveCa, 'IwaveHa': IwaveHa, 'eqPops': eqPops, 'converged': converged, 'nIter': nIter, 'atmosData': atmosData, 'exploding': exploding}
            else:
...
with ProcessPoolExecutor() as executor:
    futures = [executor.submit(cmo_synth_lte, d) for d in atmosData]
...
name = 'HerculesRadynversionLteCube.pickle'
